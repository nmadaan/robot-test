...
Open Firefox browser 
    ...
    Call Method    ${options}   set_preference    security.sandbox.content.level  0
    ...
    Call Method    ${profile}   set_preference    security.sandbox.content.level  0
    ...
    Set To Dictionary   ${desired_capabilities}  security.sandbox.content.level  0
